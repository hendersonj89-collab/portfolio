...
| Audio | `audio.py` — pad, arpeggio, written lead melody, sub/heartbeat, wind, birds, whooshes on the cuts |
...
| 39–49s | **B.C. mills first** | Stylised Vancouver Island; 14 mill towns pop with counts to 60+ / 30; "100% first offered to domestic mills" |
...
```bash
pip install numpy scipy pycairo contourpy imageio-ffmpeg
